	...
	<div class="cli_sub_tab_container">		
		<div class="cli_sub_tab_content" data-id="cookie-bar" style="display:block;">
			...
			<table class="form-table">
			    <tr valign="top">
			        <th scope="row" style="width: 260px;"><label for="is_on_field"><?php _e('Cookie Bar is currently:', 'cookie-law-info'); ?></label></th>
			        <td>
			    ...
			    <tr valign="top">
			        <th scope="row"><label for="is_eu_on_field"><?php _e('Show only for EU Countries ( GeoIP )', 'cookie-law-info'); ?></label></th>
			        <td>
			            <input type="radio" id="is_eu_on_field_yes" name="is_eu_on_field" class="styled" value="true" <?php echo ( $the_options['is_eu_on'] == true ) ? ' checked="checked"' : ''; ?> /> <?php _e('On', 'cookie-law-info'); ?>
			            <input type="radio" id="is_eu_on_field_no" name="is_eu_on_field" class="styled" value="false" <?php echo ( $the_options['is_eu_on'] == false ) ? ' checked="checked"' : ''; ?> /> <?php _e('Off', 'cookie-law-info'); ?>                                           
			        </td>
			    </tr>
			...
			<table class="form-table">
			    ...
			    <tr valign="top">
			        ...
			        <td>
			            ...
			            <span class="cli_form_help"><?php _e('Specify', 'cookie-law-info'); ?> px&nbsp;or&nbsp;&#37;, e.g. "100px" or "30%"</span>
			        </td>
			    </tr>
			    <tr valign="top">
		...
		<div class="cli_sub_tab_content" data-id="other">
			...
			<table class="form-table">
			    <tr valign="top">
			        <th scope="row"><label for="logging_on_field"><?php _e('Enable consent logging', 'cookie-law-info'); ?></label></th>
			        <td>
			            <input type="radio" id="logging_on_field_yes" name="logging_on_field" class="styled" value="true" <?php echo ( $the_options['logging_on'] == true ) ? ' checked="checked" />' : ' />'; ?> <?php _e('On', 'cookie-law-info'); ?>
			                   <input type="radio" id="logging_on_field_no" name="logging_on_field" class="styled" value="false" <?php echo ( $the_options['logging_on'] == false ) ? ' checked="checked" ' : ' '; ?> /><?php _e('Off', 'cookie-law-info'); ?>
			        </td>
			    </tr>
			    <tr valign="top" class="">
