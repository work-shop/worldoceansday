    ...
    <div class="cli_sub_tab_container">
        ...
        <div class="cli_sub_tab_content" data-id="accept-button" style="display:block;">
            ...
            <table class="form-table">
                <tr valign="top">
			        <th scope="row"><label for="accept_all_field"><?php _e('Enable accept all feature?', 'cookie-law-info'); ?></label></th>
			        <td>
			            <input type="radio" id="accept_all_yes" name="accept_all_field" class="styled" value="true" <?php echo ( $the_options['accept_all'] == true ) ? ' checked="checked"' : ''; ?> /> <?php _e('Yes', 'cookie-law-info'); ?>
                        <input type="radio" id="accept_all_no" name="accept_all_field"  class="styled" value="false" <?php echo ( $the_options['accept_all'] == false ) ? ' checked="checked"' : ''; ?> /> <?php _e('No', 'cookie-law-info'); ?>
                        <span class="cli_form_help " style="margin-top:8px;"><?php _e('This will enable all cookie categories on clicking the accept button, no matter whether they are in the enabled or disabled state.', 'cookie-law-info'); ?></span>
                        <span class="cli_form_help cli_enable_all_info" <?php echo ( $the_options['accept_all'] == false ) ? ' style="display:none;margin-top:8px;"' : 'style="margin-top:8px;"'; ?>><?php _e('Please note that you will not be able to extend the cookie consent bar with cookie settings once this option is enabled.', 'cookie-law-info'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
        ...
        <div class="cli_sub_tab_content" data-id="settings-button">
            ...
            <table class="form-table" >
                ...
                <!-- Settings As Popup -->
				<tr valign="top">
			        <th scope="row"><label for="cookie_setting_popup_field"><?php _e('Cookie Settings Layout', 'cookie-law-info'); ?></label></th>
			        <td>
			            <select name="cookie_setting_popup_field" class="vvv_combobox">
							<?php
							
			                if ($the_options['cookie_setting_popup'] == true) {
			                    echo '<option value="true" selected="selected">' . __('Popup', 'cookie-law-info') . '</option>';
			                    echo '<option value="false">' . __('Extended Banner / Widget', 'cookie-law-info') . '</option>';
			                } else {
			                    echo '<option value="true">' . __('Popup', 'cookie-law-info') . '</option>';
			                    echo '<option value="false" selected="selected">' . __('Extended Banner / Widget', 'cookie-law-info') . '</option>';
			                }
			                ?>
			            </select>
			        </td>
        ...
        <div class="cli_sub_tab_content" data-id="read-more-button">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><label for="button_2_nofollow_field"><?php _e('No Follow', 'cookie-law-info'); ?></label></th>
                    <td> 
                        <input type="radio" id="button_2_nofollow_field_yes" name="button_2_nofollow_field" class="styled" value="true" <?php echo ( $the_options['button_2_nofollow'] == true ) ? ' checked="checked"' : ''; ?> /> <?php _e('Yes', 'cookie-law-info'); ?>
                        <input type="radio" id="button_2_nofollow_field_no" name="button_2_nofollow_field" class="styled" value="false" <?php echo ( $the_options['button_2_nofollow'] == false ) ? ' checked="checked"' : ''; ?> /> <?php _e('No', 'cookie-law-info'); ?>
                        <span class="cli_form_help" style="margin-top:8px;"><?php _e('Tells search engine crawlers not to follow this link', 'cookie-law-info'); ?></span>
                    </td>
                </tr>
                <tr valign="top">
