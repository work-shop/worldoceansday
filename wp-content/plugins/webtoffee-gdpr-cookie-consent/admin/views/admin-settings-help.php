...
<div class="cookie-law-info-tab-content" data-id="<?php echo $target_id;?>">
    ...
    <div class="cli_sub_tab_container">
        <div class="cli_sub_tab_content" data-id="shortcodes" style="display:block;">
            ...
            <?php _e('You can use `do_shortcode` function to add shortcodes inside the template file.', 'cookie-law-info'); ?>
            </div>
    <ul class="cli-shortcodes">
        ...
        <?php _e('This is the "main button" you can customise.', 'cookie-law-info'); ?>
        </li>
        ...
        <li><div style="font-weight: bold;">[cookie_link]</div>
            <?php _e('This is the "read more" link you can customise.', 'cookie-law-info'); ?>
        </li>
        </ul>
        <div style="font-size: 14px;">
        ...
        <li>
            ...
            <?php _e('This prints out a nice table of cookies by category.', 'cookie-law-info'); ?>
        </li>
        <li>
            <div style="font-weight: bold;">[cookie_popup_content]</div>
            <?php _e('This prints the settings popup of cookie category.', 'cookie-law-info'); ?>
        </li>
        <li>
        ...
        <li>
            ...
            <?php _e('Add any text you like useful if you want to add another language', 'cookie-law-info'); ?>
        </li>
        <li>
            <div style="font-weight: bold;">[cookie_after_accept] Your content goes here... [/cookie_after_accept]</div>
            <?php _e('Add content after accepting the cookie notice. Category wise checking allowed', 'cookie-law-info'); ?>
            <div style="font-weight: bold;">
                [cookie_after_accept category="category1-slug"] ...Your content goes here...  [/cookie_after_accept] <br />
                <span style="font-weight: normal;"><?php _e('Add content only if the consent has been obtained for the specified category.', 'cookie-law-info'); ?></span><br />

                [cookie_after_accept category="category1-slug, category2-slug" condition="or"] ...Your content goes here...  [/cookie_after_accept] <br />
                <span style="font-weight: normal;"><?php _e('Add content if consent has been obtained for all/or any of the specified categories.', 'cookie-law-info'); ?></span><br />
            </div>
        </li>
        </ul>
        </div>
