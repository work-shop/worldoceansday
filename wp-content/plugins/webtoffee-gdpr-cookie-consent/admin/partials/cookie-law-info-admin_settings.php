...
<script type="text/javascript">
    ...
    var cli_renew_consent_success_message='<?php echo __('Consent has renewed.', 'cookie-law-info');?>';
    var cli_renew_consent_error_message='<?php echo __('Unable to renew consent.', 'cookie-law-info');?>';
</script>
<div class="wrap">
    ...
    <div class="nav-tab-wrapper wp-clearfix cookie-law-info-tab-head">
        ...
        $tab_head_arr=array(
            'cookie-law-info-general'=>__('General', 'cookie-law-info'), //no need to add translation here
            ...
            'cookie-law-info-licence'=>array(__('Licence', 'cookie-law-info'),$activate_icon),
