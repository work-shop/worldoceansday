	...
	protected function set_url( $connected_account, $endpoint_slug, $params ) {
		...
		if ( $account_type === 'basic' ) {
			if ( $endpoint_slug === 'access_token' ) {
				$url = 'https://graph.instagram.com/access_token?grant_type=ig_exchange_token&client_secret=8d671dff22da66a4eb7fe10a3ead824a&access_token=' . sbi_maybe_clean( $connected_account['access_token'] );
