...
class CustomMapObjectFields implements \IteratorAggregate, \JsonSerializable, \Countable
{
	...
	public function html()
	{
		...
		foreach($this->meta as $key => $value)
		{
			...
			$html_data = !$this->display_in_infowindows[$key] ? 'data-hide-in-infowindows="true" ' : '';
			$html_data .= !$this->display_in_marker_listings[$key] ? 'data-hide-in-marker-listings="true" ' : '';
