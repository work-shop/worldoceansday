...
if (!class_exists("WD_ASP_StyleSheets_Action")) {
    ...
    class WD_ASP_StyleSheets_Action extends WD_ASP_Action_Abstract {
        ...
        public function handle() {
            ...
            if ( $load_chosen ) {
                wp_register_style('wpdreams-asp-chosen', ASP_URL . 'css/chosen/chosen.css', array(), $media_query);
            ...
            wp_enqueue_style('wpdreams-ajaxsearchpro-instances', wd_asp()->upload_url . 'style.instances.css', array(), $media_query);
        }
