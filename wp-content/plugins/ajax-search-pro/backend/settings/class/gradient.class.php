        ...
        function getType() {
            ...
            <div class='wpdreamsGradient'>
                ...
                <div class="grad_slider">
                    <div class="dslider" data-rotation="<?php echo $this->rotation; ?>"></div>
                    <div class='ddisplay'>
                        <div class='dbg'></div>
                    </div>
                    <div class="dtxt"><?php echo $this->rotation ?></div>&#176;
                </div>

                <input isparam=1 type='hidden' class='gradient' name="<?php echo $this->name ?>" value="<?php echo $this->data ?>"/>
