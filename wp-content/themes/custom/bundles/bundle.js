...
function events() {
	...
	function getEvents() {
		...
		var country = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'all';
...
var _submitEvent = require('./submit-event.js');
...
$(document).ready(function () {
	...
	if ($('body').hasClass('post-type-archive-resources')) {
		(0, _resources.resources)(_modals.modals);
	}
	if ($('body').hasClass('page-id-13')) {
		(0, _events.events)();
	}
	if ($('body').hasClass('page-id-11')) {
		(0, _submitEvent.submitEvent)();
	}
});
...
function resources() {
	...
	function getResources() {
		var topic = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'all';
		var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'all';
		var language = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'all';
