...
function dropdowns(config) {
	...
	$(document).ready(function () {
		...
		$(config.linkSelector).hover(function () {
		...
		$(config.blanketSelector).hover(function () {
			if (window.innerWidth > 767) {
				closeDropdown();
			}
		}, function () {
...
var jqueryAccordian = function jqueryAccordian() {
...
exports.jqueryAccordian = jqueryAccordian;
...
exports.linksNewtab = linksNewtab;
...
var _viewportLabel = require('./viewport-label.js');

var _linksNewtab = require('./links-newtab.js');

var _jqueryAccordian = require('./jquery-accordian.js');

var _accordian = require('./accordian.js');

var _jumpLinks = require('./jump-links.js');

var _modals = require('./modals.js');

var _slickSlideshows = require('./slick-slideshows.js');

var _sitewideAlert = require('./sitewide-alert.js');

var _progressiveImages = require('./progressive-images.js');

var _vh = require('./vh.js');
...
var _scrollSpy = require('./scroll-spy.js');

var _events = require('./events.js');

var _stickyNav = require('./sticky-nav.js');
...
//must use 
(0, _nav.nav)();
(0, _scrollSpy.scrollSpy)(_config.config.scrollSpy);
(0, _livereloadClient.livereload)();
(0, _loading.loading)(_config.config.loading);
(0, _linksNewtab.linksNewtab)(_config.config.linksNewtab);
(0, _viewportLabel.viewportLabel)(_config.config.viewportLabel);
(0, _jqueryAccordian.jqueryAccordian)();
(0, _accordian.accordian)();
(0, _jumpLinks.jumpLinks)(_config.config.jumpLinks);
(0, _modals.modals)(_config.config.modals);
(0, _slickSlideshows.slickSlideshows)(_config.config.slickSlideshows);
(0, _sitewideAlert.sitewideAlert)();
(0, _progressiveImages.progressiveImages)();
(0, _vh.vh)();
//makeMap();
(0, _stickyNav.stickyNav)(_config.config.stickyNav);
(0, _events.events)(_config.config.stickyNav);

//optional
(0, _dropdowns.dropdowns)(_config.config.dropdowns);
(0, _menuToggle.menuToggle)(_config.config.menuToggle);
...
},{"./accordian.js":3,"./config.js":4,"./dropdowns.js":5,"./events.js":6,"./jquery-accordian.js":7,"./jump-links.js":8,"./links-newtab.js":9,"./livereload-client.js":10,"./loading.js":11,"./menu-toggle.js":13,"./modals.js":14,"./nav.js":15,"./news.js":16,"./progressive-images.js":17,"./scroll-spy.js":18,"./sitewide-alert.js":19,"./slick-slideshows.js":20,"./sticky-nav.js":21,"./vh.js":22,"./viewport-label.js":23,"jquery":1}],13:[function(require,module,exports){
"use strict";
...
function news() {
	...
	function renderPost(post) {
		...
		var root = $('<article>').addClass('news-post');

		var card = $('<div>').addClass('card-post');

		var imageContainer = $('<div>').addClass('card-image');
		...
		var link1 = $('<a>').attr('href', post.link);

		var link2 = $('<a>').attr('href', post.link).html(post.title.rendered);

		var textContainer = $('<div>').addClass('card-text');

		var date = $('<h5>').addClass('card-post-date').html(post.acf.publish_date);

		var title = $('<h4>').addClass('card-post-title');
...
exports.progressiveImages = progressiveImages;
...
exports.sitewideAlert = sitewideAlert;
...
exports.slickSlideshows = slickSlideshows;

},{"slick-carousel":2}],21:[function(require,module,exports){
'use strict';
...
function stickyNav(config) {
	...
	$(document).ready(function () {
		...
		if ($('.page-nav').length) {
			...
			$('body').on({ 'touchmove': function touchmove() {
...
exports.viewportLabel = viewportLabel;
