...
<?php if( get_field('show_list_your_event_banner')): ?>
	<?php if( !isset($_COOKIE['wod_show_list_your_event_banner']) || $_COOKIE['wod_show_list_your_event_banner'] === false ): ?>
				...
				<div class="row">
					<div class="col-lg-4 offset-lg-2 list-your-event-banner-1">
						<h3 class="brand font-black">
							<?php the_field('list_your_event_banner_text'); ?>
						</h3>
					</div>
					<div class="col-lg-3 offset-lg-1 list-your-event-banner-2">
						<?php $link = get_field('list_your_event_banner_link'); ?>
						<?php if( $link ): ?>
