<section class="block padded" id="take-action-now">
	<div class="container-fluid">
		<?php if( get_field('get_involved_on_wod_heading')): ?>
			<div class="section-heading-container">
				<h3 class="section-heading">
					<?php the_field('get_involved_on_wod_heading'); ?>
				</h3>
			</div>
		<?php endif; ?>
		<?php $cards = get_field('get_involved_on_wod_cards'); ?>
		<?php if( $cards ): ?>
		...
		<?php endif; ?>
		<?php if( get_field('section_callout_image_1') && get_field('section_callout_heading_1') ): ?>
		<div class="callout-container">
			<div class="overview-block">
				<div class="overview-block-text" >
					<div class="overview-block-text-inner">
						<h2 class="block-heading">
							<?php the_field('section_callout_heading_1'); ?>
						</h2>
						<?php if( get_field('section_callout_link_1') ): ?>
							<?php $link = get_field('section_callout_link_1'); ?>
				...
				<?php $image = get_field('section_callout_image_1');
