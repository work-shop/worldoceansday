	...
	public static function fc_background_text( $background_type, $heading, $text_alignment, $section_text_color_string, $subheading, $link_url, $link_text ){ ?>
		<?php if( $heading ): ?>
			<div class="fc-background-heading <?php if( $background_type !== 'multi-column' ): echo $text_alignment; endif; ?>">
				<h2 class="<?php if( $background_type !== 'multi-column' ): echo $text_alignment; endif; ?>" <?php echo $section_text_color_string; ?>>
					<?php echo $heading; ?>
				</h2>
			</div>
		<?php endif; ?>
		<?php if( $heading ): ?>
			<div class="fc-background-subheading <?php if( $background_type !== 'multi-column' ): echo $text_alignment; endif; ?>">
				<h3 class="<?php if( $background_type !== 'multi-column' ): echo $text_alignment; endif; ?>" <?php echo $section_text_color_string; ?>>
					<?php echo $subheading; ?>
				</h3>
			</div>
		<?php endif; ?>
		<?php if( $link_url ): ?>
			<div class="fc-background-link fc-button <?php if( $background_type !== 'multi-column' ): echo $text_alignment; endif; ?>">
				<a href="<?php echo $link_url; ?>" class="" <?php echo $section_text_color_string; ?>>
					<?php echo $link_text; ?>
				</a>
			</div>
		<?php endif; ?>
